    ...
    return (
      ...
      <div
        ...
        className={cn(
          ...
          "flex w-full flex-col rounded-xl border border-white/10 bg-black/50 p-2 text-white shadow-sm",
            ...
            >
              ...
              {files.map((file) => (
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-2 py-1 text-sm text-white"
        ...
        <div className="relative flex w-full items-end">
          ...
          <Textarea
            ...
            className={cn(
              ...
              "min-h-[40px] w-full resize-none border-none bg-transparent pr-20 text-white placeholder:text-white/50 shadow-none focus-visible:ring-0",
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          >
            ...
            <Button
              ...
              className={cn("rounded-full bg-white text-black hover:bg-white/90", sendButtonProps?.className)}
